...
import com.terzeron.springboot.*;
...
@ExtendWith(SpringExtension.class) public class InventoryServiceUnitTest {
    ...
    @Test void addItemToEmptyCartShouldProduceOneCartItem() {
        inventoryService.addItemToCart("My Cart", "item1").as(StepVerifier::create).expectNextMatches(cart -> {
    ...
    @Test void alternativeWayToTest() {
