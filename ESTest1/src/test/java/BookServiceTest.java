import net.terzeron.springboot.Application;
import net.terzeron.springboot.Book;
import net.terzeron.springboot.BookService;
...
public class BookServiceTest {
    ...
    public void testSave() {
        Book book = new Book("1001", "Elasticsearch Basics", "Ramboo Posa", "23-FEB-2017");
    ...
    public void testFindByTitle() {
        ...
        assertThat(byTitle.size(), CoreMatchers.is(1));
    }
    ...
    public void testFindByAuthor() {
        ...
        assertThat(byAuthor.getTotalElements(), CoreMatchers.is(4L));

        Page<Book> byAuthor2 = bookService.findByAuthor("Mkyong", new PageRequest(0, 10));
        assertThat(byAuthor2.getTotalElements(), CoreMatchers.is(1L));
